    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-xl">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-semibold text-slate-900">Create your Saarthi account</h1>
        ...
        <div className="mt-6 rounded-xl border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600">
          ...
          <p className="mt-1">Your workspace focuses only on Nepal passport preparation and readiness guidance.</p>
        </div>
      </div>
    </div>
  );
